...
public class DBOpenHelper extends SQLiteOpenHelper{
    ...
    public void onCreate(SQLiteDatabase db){              //创建数据库
        ...
        db.execSQL("create table tb_inaccount (_id integer primary key,money decimal,time varvhar(10),"+
                 "type varchar(10),handler varchar(100),mark varchar(20))");        //创建收入信息表
        db.execSQL("create table tb_psw(password varchar(20))");        //创建密码表
        db.execSQL("create table tb_flag(_id integer primary key,flag varchar(20))");        //创建便签信息表
    }
